...
class AnalysisConfig(Base):
    ...
    biological_band_min_hz: Mapped[float] = mapped_column(Float, default=2000.0)
    biological_band_max_hz: Mapped[float] = mapped_column(Float, default=8000.0)
    ...
    bootstrap_iterations: Mapped[int] = mapped_column(Integer, default=500)
    temporal_bootstrap_iterations: Mapped[int] = mapped_column(Integer, default=500)
    temporal_stable_threshold_per_year: Mapped[float] = mapped_column(Float, default=1.0)
    temporal_strong_threshold_per_year: Mapped[float] = mapped_column(Float, default=5.0)
...
class ProjectSummary(Base):
    ...
    median_distance_to_healthy: Mapped[float | None] = mapped_column(Float, nullable=True)
    median_distance_to_degraded: Mapped[float | None] = mapped_column(Float, nullable=True)
    ...
    bootstrap_requested_iterations: Mapped[int] = mapped_column(Integer, default=0)
    ...
    reference_profiles: Mapped[dict] = mapped_column(JSON, default=dict)
    temporal_result: Mapped[dict] = mapped_column(JSON, default=dict)
