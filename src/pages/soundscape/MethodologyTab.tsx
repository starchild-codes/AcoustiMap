...
export default function MethodologyTab() {
  const steps = [
    ...
    { icon: Database, title: 'Scientific ecoacoustic metrics are generated externally in Python', desc: 'ACI, BI, spectral entropy, and reference similarity are computed by an external Python analysis pipeline — not in the browser.' },
  ...
  const table: { output: string; where: string; interpretation: string }[] = [
    ...
    { output: 'BI', where: 'Python pipeline', interpretation: 'Ecoacoustic feature' },
      ...
      <div className="card p-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-charcoal-700"><strong>Python imported</strong> — Ecoacoustic metrics (ACI, BI, spectral entropy, similarity) generated by the external Python pipeline and imported as JSON.</span>
          </div>
          <div className="flex items-center gap-2">
